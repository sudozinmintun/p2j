...
<head>
    ...
    <meta name="description"
        content="Cloud-based development services with Python, PHP, and JavaScript. We offer scalable and secure solutions for modern web applications.">
    <meta name="keywords"
        content="Cloud Development, Python, PHP, JavaScript, Web Development, Cloud Solutions, Scalable Web Apps">
    <meta name="author" content="p2jcloud.online">

    <!-- Open Graph Tags (For Social Media Sharing) -->
    <meta property="og:title" content="Cloud-Based Development with Python, PHP, and JS">
    <meta property="og:description"
        content="Scalable and secure cloud development services using Python, PHP, and JavaScript. Contact us for customized solutions.">
    <meta property="og:url" content="p2jcloud.online">
    <meta property="og:type" content="website">

    <!-- Twitter Card Tags (For Twitter Sharing) -->
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="Cloud-Based Development with Python, PHP, and JS">
    <meta name="twitter:description"
        content="We specialize in cloud development using Python, PHP, and JavaScript. Scalable and secure solutions for your business needs.">
    <meta name="twitter:site" content="@yourtwitterhandle">

    <!-- Canonical Tag (Avoid Duplicate Content Issues) -->
    <link rel="canonical" href="p2jcloud.online">

    <title>Cloud Based Development With Python, PHP, and JS. - @yield('title')</title>
...
<body>
    ...
    <div class="d-flex gap-6">
        ...
        <div class="main-content w-100">
            ...
            <div
                ...
                <a href="{{ route('home') }}" class="side-icon bgn2-color brn4">
                ...
                <div class="d-flex gap-3 align-items-center">
                    <a href="mailto:info@p2jcloud.online" class="position-relative">
                        <div class="side-icon bg1-color">
                            <i class="ph ph-envelope n11-color"></i>
                        </div>
                    </a>

                    <a href="{{ route('contact.index') }}" class="position-relative">
                        <button class="side-icon bg1-color mood_toggle">
                            <i class="mood_icon ph-fill ph-paper-plane-tilt fs-six n11-color"></i>
                        </button>
                    </a>
                </div>
            </div>
    ...
    <script src="{{ asset('assets/js/type-word.js') }}"></script>
</body>
