...
class ClientsController extends SecureController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if(!empty($request->search)){
			...
			$search_condition = "(
				clients.id LIKE ? OR 
				clients.title LIKE ? OR 
				clients.description LIKE ? OR 
				clients.photo LIKE ? OR 
				clients.link LIKE ? OR 
				clients.created_at LIKE ? OR 
				clients.updated_at LIKE ? OR 
				clients.category_id LIKE ?
			)";
			$search_params = array(
		...
		$db->join("categories", "clients.category_id = categories.id", "INNER");
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("title","description","photo","link","category_id");
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("id","title","description","photo","link","category_id");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'title' => 'required',
