...
class ExpensesController extends SecureController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if(!empty($request->search)){
			...
			$search_condition = "(
				expenses.id LIKE ? OR 
				expenses.date LIKE ? OR 
				expenses.title LIKE ? OR 
				expenses.cost LIKE ? OR 
				expenses.type LIKE ? OR 
				expenses.remark LIKE ? OR 
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("date","title","cost","type","remark");
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("id","date","title","cost","type","remark");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'date' => 'required',
