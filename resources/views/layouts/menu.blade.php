        ...
        <div class="side-menu-left">
            <div>
                <div class="d-flex flex-column gap-8 justify-content-center align-items-center mt-6">
                    <a href="{{ route('home') }}" class="side-icon p1-color bgn2-color brn4">
                    ...
                    <a href="{{ route('contact.index') }}" class="position-relative">
                        <div class="side-icon bg1-color">
                            <i class="ph ph-paper-plane-tilt n11-color"></i>
                        </div>
                    </a>
                    ...
                    <div class="sidebar-profile">
                        <div class="position-relative">
                            <div class="profile-img1 d-flex justify-content-center overflow-hidden">
                                <img src="{{ asset('assets/images/photo.jpg') }}" alt="user" class="" />
                            </div>
                        ...
                        <span class="n5-color fs-nine d-block text-center">
                            With Python, PHP, and JS.
                        </span>

                        <div class="d-flex justify-content-center gap-2 align-items-center mt-4">
                            <a href="https://www.facebook.com/p2jcloud.online" target="_blank"
                    ...
                    <div class="menu-list">
                        <ul class="d-flex flex-column gap-3">
                            ...
                            <li class="rounded-3">
                                <a href="{{ route('client.index') }}"
                                    ...
                                    <div class="d-flex align-items-center gap-2 n5-color fs-eight px-3 py-2">
                                        <i class="ph ph-code-block fs-six"></i>
                                        Clients
                                    </div>
                                    <span class="n5-color bg2-color fs-ten px-1 pt-1 rounded-2 me-3">
                                        {{ $total_client }}
                                    </span>
                                </a>
                            </li>
                            ...
                            <li class="rounded-3">
                                <a href="{{ route('services') }}"
                                    class="d-flex align-items-center gap-2 n5-color fs-eight px-3 py-2"><i
                                        class="ph ph-briefcase fs-six"></i>
                                    Services & Pricing
                                </a>
                            </li>
                            ...
                            <li class="rounded-3">
                                <a href="{{ route('resume') }}"
                                    class="d-flex align-items-center gap-2 n5-color fs-eight px-3 py-2">
                                    <i class="ph ph-notebook fs-six"></i>
                                    Resume
                                </a>
                            </li>
                            ...
                            <li class="rounded-3">
                                <a href="{{ route('blog.index') }}"
                                    class="d-flex align-items-center gap-2 n5-color fs-eight px-3 py-2">
                                    <i class="ph ph-newspaper-clipping fs-six"></i>
                                    Blog
                                </a>
                            </li>
                            ...
                            <li class="rounded-3">
                                <a href="{{ route('contact.index') }}"
                                    class="d-flex align-items-center gap-2 n5-color fs-eight px-3 py-2">
                                    <i class="ph ph-envelope fs-six"></i>
                                    Contact
                                </a>
                            </li>
                        </ul>
